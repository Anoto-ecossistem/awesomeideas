    ...
    <head>
        ...
        <style>
            ...
            ::after,::before{--tw-content:''}html{line-height:1.5;-webkit-text-size-adjust:100%;-moz-tab-size:4;
                tab-size:4;font-family:Figtree, sans-serif;font-feature-settings:normal}
                ...
                <div class="mt-16">
                    ...
                    @if(!empty($repositories))
                        @foreach($repositories as $repo)
                            <h2 class="mt-5">{{ $repo['name'] }}</h2>
                            <p><strong>Description:</strong> {{ $repo['description'] }}</p>
                            <p><strong>Stars:</strong> {{ $repo['stargazers_count'] }}</p>
                            <p><strong>Forks:</strong> {{ $repo['forks_count'] }}</p>
                            <p><strong>Owner:</strong> {{ $repo['owner']['login'] }}</p>
                            <p class="mb-5"><a href="{{ $repo['html_url'] }}" target="_blank">Repository Link</a></p>
                            <hr>
                        @endforeach
                    @else
